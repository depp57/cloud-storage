...
docker build -t registry.gitlab.com/sthommet/cloud-storage/client-ep -f clientEndpoint/Dockerfile .
docker push registry.gitlab.com/sthommet/cloud-storage/client-ep
